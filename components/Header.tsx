    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/70 backdrop-blur-md border-b border-slate-200/60">
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <button className="hidden sm:block px-5 py-2.5 rounded-full text-sm font-semibold bg-slate-900 text-white hover:bg-teal-700 transition-all shadow-lg shadow-slate-900/10">
            Request Demo
          </button>
          <button className="p-2 md:hidden text-slate-600">
            <Menu size={24} />
          </button>
        </div>
      </div>
